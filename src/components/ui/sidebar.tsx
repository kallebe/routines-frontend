  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-main-foreground text-secondary-background flex h-full w-(--sidebar-width) flex-col",
          className,
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-main-foreground text-secondary-background w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r-2 border-r-border-light group-data-[side=right]:border-l-2 border-l-border-light",
          className,
        )}
        {...props}
      >
        <div
          ...
          className="bg-foreground text-secondary-background flex h-full w-full flex-col"
        >
          {children}
        </div>
      </div>
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        "flex flex-col gap-2 p-2 border-b-2 border-b-border-light",
        className,
      )}
      {...props}
    />
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        "flex flex-col gap-2 p-2 border-t-2 border-t-border-light",
        className,
      )}
      {...props}
    />
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative flex w-full min-w-0 flex-col p-2 border-b-2 border-b-border-light last:border-b-0",
        className,
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-white ring-ring flex h-8 shrink-0 items-center rounded-base px-2 text-sm font-heading outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
